...
import { IconFolderPlus, IconFileOff } from '@tabler/icons-react';
...
//   onClearFiles
    ...
    useEffect(() => {
    }, [fileObjs, fileList,currentShowFile,currentShowFile]);
  ...
  return (
    ...
    >
      <div className="flex items-center">
        <button
          className="flex w-[240px] flex-shrink-0 cursor-pointer select-none items-center gap-3 rounded-md border border-white/20 p-3 text-[14px] leading-normal text-white transition-colors duration-200 hover:bg-gray-500/10"
          onClick={onNewFile}
        >
        ...
        {showConfirmationDialog && (
                            ...
                            <div className="bg-gray-700 p-10 rounded shadow-md w-1/3">
                                ...
                                <button
                                    ...
                                    onClick={async () => {
                                    setShowConfirmationDialog(false);
                                    await handleFile(nowSelectedFile);
                                    }}
                                >
                                    确认
                                </button>
